    ...
    <main>
        ...
        <section>
            <div id="container_module_slider">
                <img src="http://localhost/primeraprueba/images/imginicio.jpg" alt="" class="imagenanimate">
            </div>

            <div id="container_module_us">
                <div class="center">
                    <div class="row_module_us">
                        <div class="column_rightUs">
                            <h2>NOSOTROS</h2>
                            <h3>Tu aliado en la lucha legal</h3>
                            <p>En <strong>Deudas Judiciales Perú</strong>, nos dedicamos a transformar tus desafíos legales en oportunidades. Nuestro compromiso con la excelencia y la innovación nos permite ofrecerte servicios de consultoría de alta calidad. Con un enfoque personalizado y el respaldo de modernas plataformas digitales, estamos aquí para guiarte en cada paso del proceso judicial. Tu tranquilidad es nuestra misión.</p>

                            <div class="btn_us">	
                                <a href="http://localhost/primeraprueba/Nosotros.php">CONOCE MÁS</a>
                            </div>
                        </div>
                        <div class="column_leftUs">
                            <img src="http://localhost/primeraprueba/images/imginicio.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
