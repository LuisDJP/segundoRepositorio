...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/primeraprueba/css/styless2.css">
    ...
    <main>
        ...
        <section>
            <div id="container_module_slider">
                <img src="http://localhost/primeraprueba/images/imgEquipo.jpg" alt="" class="imagenanimate">
            </div>

            <div id="container_module_services">
                <div class="center">
                    <div class="row_services">
                        <h2>Nuestro Equipo</h2>
                        <div class="text_contentUs">
                            <p>
                                En "Deudas Judiciales Perú", contamos con un equipo de profesionales altamente calificados y con una amplia experiencia en el ámbito legal. Cada miembro de nuestro equipo ha sido seleccionado no solo por su conocimiento técnico, sino también por su compromiso con la excelencia y la atención al cliente.
                                <br><br>
                                Nuestros abogados y consultores se especializan en diversas áreas del derecho, lo que nos permite abordar cada caso de manera integral y efectiva. Trabajamos en estrecha colaboración, aprovechando la experiencia colectiva para desarrollar estrategias innovadoras y personalizadas que aseguran los mejores resultados para nuestros clientes.
                                <br><br>
                                En cada paso del proceso, nuestro equipo se dedica a ofrecer una asesoría clara y proactiva, manteniendo siempre una comunicación abierta para que nuestros clientes estén informados y seguros en cada decisión que tomen. 
                                <br><br>
                                Con "Deudas Judiciales Perú", tienes la certeza de que tu caso está en manos expertas, dispuestas a luchar por tus derechos y encontrar soluciones a tus problemas legales.
                            </p>
                        </div>
                    </div>
                </div>            
                                ...
                                <li>
                                    <div class="row_content_services">
                                        ...
                                        <div class="content_image_services">
                                            <a href="">Abogado Nombre y Apellido, cargo e información importante</a>
                                        </div>
                                    </div>
                                </li>
